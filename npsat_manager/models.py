...
class ModelRun(models.Model):
    ...
    # the range should be between 0 - 3000;
    # 3001 is reserved for the maximum value possible, when passing to message to mantis, set it to 10000
    ...
    # the range should be between 0 - 1500;
    # 1501 is reserved for the maximum value possible, when passing to message to mantis, set it to 10000
    ...
    def input_message(self):
        ...
        if self.applied_simulation_filter:
            if self.depth_range_min is not None and self.depth_range_max is not None:
                range_max = str(self.depth_range_max) if self.depth_range_max != 3001 else "10000"
            ...
            if self.screen_length_range_min is not None and self.screen_length_range_max is not None:
                range_max = str(self.screen_length_range_max) if self.depth_range_max != 1501 else "10000"
